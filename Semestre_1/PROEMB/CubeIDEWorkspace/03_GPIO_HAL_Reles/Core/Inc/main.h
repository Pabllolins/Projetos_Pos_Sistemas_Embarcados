...
#define Encoder_DT_Pin GPIO_PIN_3
...
#define Rele_IN1_Pin GPIO_PIN_10
#define Rele_IN1_GPIO_Port GPIOC
#define Rele_IN2_Pin GPIO_PIN_12
#define Rele_IN2_GPIO_Port GPIOC
